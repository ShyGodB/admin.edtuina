    ...
    <div id="Feedback" class="bg-white">
        ...
        <div class="techapply-table">
            <el-table :data="feedbacks" style="width: 100%">
                ...
                <el-table-column prop="labels" label="回复人"></el-table-column>

                <el-table-column prop="remark" label="回复内容"></el-table-column>

                <el-table-column prop="evidence" label="时间"></el-table-column>
