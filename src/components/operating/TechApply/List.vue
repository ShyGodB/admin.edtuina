<template>
  <div id="TechApply">
    ...
    <div class="order-table">
      <el-table :data="techApplys" style="width: 100%">
        ...
        <el-table-column prop="addTime" label="申请时间" width="100" height="120"></el-table-column>

        <el-table-column prop="state" label="正常" width="160" height="120"></el-table-column>
...
export default {
  ...
  methods: {
    ...
    listTechApply(data) {
      axios({
        method: "post",
        url: "/api/admin/other/listTechApply",
        responseType: "json",
        data: data
      }).then(res => {
        this.techApplys = res.data.data.list || [];
